...
import {
  useCart,
  useDispatchCart,
} from "../Components/ContextReducer/ContextReducer";
const Cart = () => {
  let data = useCart();
  ...
  const handleCheckOut = async () => {
    ...
    console.log("Email After Handle Checkout Click : " + userEmail);
    ...
    console.log("Handle Checkout Order Response: ", response);
